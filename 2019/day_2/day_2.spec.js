...
describe('Day 2', () => {
  ...
  describe('restoreLastState', () => {
    it('should modify the correct values', () => {
      expect(day2.restoreLastState([0, 1, 2, 3, 4, 5])).toEqual([0, 12, 2, 3, 4, 5]);
    });
  });
  ...
  describe('readIntCode', () => {
    it('should calculate correctly', () => {
      ...
      expect(day2.readIntCode([2, 4, 4, 5, 99, 0])).toEqual([2, 4, 4, 5, 99, 9801]);
  ...
  describe('Solution', () => {
    it('should solve part 1', () => {
      expect(day2.readIntCode(day2.restoreLastState(input))[0]).toEqual(6327510);
    });

    it('should solve part 2', () => {
      expect(day2.findNounAndVerb(input)).toEqual(4112);
    });
  });
});
